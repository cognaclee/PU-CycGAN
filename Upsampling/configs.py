...
parser.add_argument('--train_file', default='data/kitti_crop_256-semantic3d_1024.h5')
...
parser.add_argument('--use_non_uniform', type=str2bool, default=False)
...
parser.add_argument('--use_uniform', type=str2bool, default=True)
parser.add_argument('--repulsion_w', default=10.0, type=float, help="repulsion_weight")
parser.add_argument('--fidelity_w', default=100.0, type=float, help="fidelity_weight")
parser.add_argument('--uniform_w', default=60.0, type=float, help="uniform_weight")
parser.add_argument('--midDist_w', default=120.0, type=float, help="gan_weight")
parser.add_argument('--gan_w', default=5.8, type=float, help="gan_weight")
...
parser.add_argument('--which_model', default='real', type=str, help="supervised, synthesis or real")
parser.add_argument('--up_or_down', default='up', type=str, help="up or down")
